...
* Here we're able to inspect a pod to see if a runtiemclass has been applied
  ```
...
* In order to see events generated by Falco is to run the journalctl -u falco command.
